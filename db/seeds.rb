...
park_burger = Restaurant.create(name: "Park Burger", logo: "https://www.parkburgeroman.com/images/logo.png", rating: 5, price: "$$", phone_number: "(720) 242-9951", location_id: rino.id, cuisine_id: american.id)
...
north_italia = Restaurant.create(name: "North Italia", logo: "https://pinpointretail.com/wp-content/uploads/2017/05/projects-northitalia.png", rating: 5, price: "$$", phone_number: "(720) 941-7700", location_id: cherry_creek.id, cuisine_id: italian.id)
...
d_corazon = Restaurant.create(name: "D'Corazon Mexican Restaurant", logo: "https://i.pinimg.com/originals/c2/ad/39/c2ad398fbb8546a93235cf11ef0dad3f.png", rating: 5, price: "$", phone_number: "(720) 904-8226", location_id: lodo.id, cuisine_id: mexican.id)
