...
sushi_den = Restaurant.create(name: "Sushi Den", logo: "https://www.sushiden.net/wp-content/themes/sushiden/images/logo-white.png", rating: 5, price: "$$$", phone_number: "(303) 777-0826", location_id: wash_park.id, cuisine_id: sushi.id)
